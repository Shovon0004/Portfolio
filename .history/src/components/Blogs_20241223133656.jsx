...
const Blog = () => {
  ...
  return (
    <div className=" dark:bg-gray-900min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 text-white p-8 relative">
      <motion.div
      ...
      >
        <h1 className="text-4xl font-bold mb-2 dark:bg-gray-900">My Blogs</h1>
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="dark:bg-gray-900 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white text-lg font-semibold rounded-md shadow-md transition"
        >
          Know More
        </a>
      </motion.div>
