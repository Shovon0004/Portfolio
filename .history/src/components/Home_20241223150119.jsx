    ...
    return (
        <motion.div className="mx-auto w-full max-w-7xl dark:bg-gray-900">
            <aside className="relative overflow-hidden dark:bg-gray-900 rounded-lg sm:mx-16 mx-2 sm:py-16">
                ...
                <motion.div
                    className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full dark:bg-gray-900"
            ...
            {/* Flexbox container for CV section */}
            <div className="flex flex-col items-center justify-center gap-8 py-10 dark:bg-gray-900">
                {/* Text */}
                <motion.h1
                    className="text-2xl sm:text-5xl font-bold text-gray-900 dark:text-white transition-colors duration-200"
                    initial={{ opacity: 0, x: -100 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6, ease: "easeOut" }}
                >
                ...
                <button
                    ...
                    className="rounded-full bg-gray-300 hover:bg-gray-400 dark:bg-blue-900 dark:hover:bg-gray-600 
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.8, ease: "easeOut" }}
                >
                    <img className="sm:w-96 w-48" src="/public/1234.png" alt="image2" />
                </motion.div>
            </div>
        </motion.div>
    );
