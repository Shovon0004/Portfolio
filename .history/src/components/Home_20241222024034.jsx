...
export default function Home() {
    ...
    return (
      ...
      <span>Download Cv</span>
            ...
            <h1 className="relative text-2xl sm:text-5xl py-10 font-bold text-gray-900 dark:text-white transition-colors duration-200">
    Here is my CV
</h1>

            <div className=" grid  place-items-end sm:mt-20 dark:bg-gray-900">
                <img className="sm:w-96 w-48 mb" src="https://i.ibb.co/2M7rtLk/Remote1.png" alt="image2" />
