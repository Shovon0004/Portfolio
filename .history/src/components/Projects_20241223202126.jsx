...
const Projects = () => {
    ...
    const projects = [
  {
        ...
        },
    {
      ...
      githubLink: "https://github.com/Shovon0004/TO-DO-LIST.git",
      liveLink: "https://your-ecommerce.com",
      image: "https://tse2.mm.bing.net/th?id=OIP.1ARw8pvH3jngSnbgRqN0RQHaEJ&pid=Api&P=0&h=180"
        },
    {
      id: 5,
      title: "Bluetooth Rover",
      description: "A rover that can be controlled using a smartphone. The rover is equipped with Bluetooth connectivity and can be controlled using a mobile app. The app allows users to move the rover in different directions and control its speed.",
      tech: ["Esp-32", "Bluetooth", "Android","objective-c"],
      githubLink: "https://github.com/Shovon0004/bluetooth_rover.git",
      liveLink: "https://your-ecommerce.com",
      image: "https://www.engineersgarage.com/wp-content/uploads/2019/07/Image-Showing-Bluetooth-Controlled-Spy-Rover.jpg"
    }
    
  ];

  return (
    <div className=" mx-auto w-full container mx-auto mx-auto w-full py-16 dark:bg-gray-900">
      <motion.h2 
