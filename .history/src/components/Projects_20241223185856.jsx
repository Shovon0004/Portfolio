...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      id: 3,
      title: "Snake Game",
      description: "A classic Snake game built with React. This game features a grid-based layout, user-controlled snake movement, and food generation. Users can control the snake's direction using arrow keys and grow the snake by eating food.",
