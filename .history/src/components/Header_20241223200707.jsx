...
import { Moon, Sun, GitFork, Menu, X } from "lucide-react";
      ...
      <nav className="bg-white border-gray-800 px-4 lg:px-6 py-2.5 dark:bg-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <Link
              to="https://github.com/Shovon0004/Portfolio/fork"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 bg-rose-700 rounded-lg hover:bg-rose-900 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center space-x-2"
              title="Fork My Repo"
            >
              <GitFork className="w-5 h-5 text-white" />
              <span className="text-white">Fork My Repo</span>
            </Link>
            {/* Mobile menu toggle button */}
            <button
              onClick={() => setMenuOpen(!menuOpen)}
              className="p-2 ml-4 lg:hidden focus:outline-none"
