...
export default function Home() {
    ...
    return (
        <div className="mx-auto w-full max-w-7xl dark:bg-gray-900">
            ...
            <div className=" grid   sm:mt-20 dark:bg-gray-900">
                <h1 className="relative mt-12 text-2xl sm:text-5xl py-10 font-bold text-gray-900 dark:text-white transition-colors duration-200">
    Here is my CV
            </h1>
      ...
      <span>Download Cv</span>
                ...
                <img className="sm:w-96 w-48 placeholder-item-end mb-10"  src="https://i.ibb.co/2M7rtLk/Remote1.png" alt="image2" />
