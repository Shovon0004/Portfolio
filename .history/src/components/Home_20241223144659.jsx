...
export default function Home() {
    ...
    return (
        ...
        transition={{ duration: 0.6, ease: "easeOut" }}>
            ...
            <motion.h1 className="relative text-2xl initial={{ opacity: 0, y: -100 }}
                    animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }} py-10 font-bold text-gray-900 dark:text-white transition-colors duration-200"
                initial={{ opacity: 0, x: -100 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6, ease: "easeOut" }}
            >
