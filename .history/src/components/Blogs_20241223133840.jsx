...
const Blog = () => {
  ...
  return (
    <div className=" dark:bg-gray-900min-h-screen flex flex-col items-center justify-center  text-white p-8 relative">
      <motion.div
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="px-6 py-1 bg-indigo-600 hover:bg-indigo-500 text-white text-lg font-semibold rounded-md shadow-md transition"
        >
          Know More
        </a>
      </motion.div>
