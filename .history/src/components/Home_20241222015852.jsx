                ...
                <div className="relative z-10 max-w-screen-xl px-4  pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
                    <div className="max-w-xl sm:mt-1 mt-80 space-y-8 text-center sm:text-right sm:ml-auto dark:bg-gray-800">
                        <h2 className="text-4xl font-bold sm:text-5xl dark:bg-gray-800">
                            ...
                            Hey, I'm Shovon Halder! 😊I'm always eager to learn new things and take on challenging projects. I'm looking forward to contributing to our collective success and sharing my experiences.

                            <span className="hidden sm:block text-4xl">CV</span>
                        </h2>
