        ...
        >
                ...
                <div className="space-y-4">
                    <div className="p-4 rounded-lg bg-gray-100 dark:bg-gray-800">
                        ...
                        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300">
                            <li>Developed and optimized user-friendly web pages using React and Tailwind CSS.</li>
                            <li>Collaborated with designers to implement responsive UI/UX components.</li>
                        </ul>
                    </div>
                    <div className="p-4 rounded-lg bg-gray-100 dark:bg-gray-800">
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                        ...
                        <p className="text-gray-700 dark:text-gray-300">Self-Employed, 2022 - Present</p>
                        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300">
                            <li>Built custom websites for clients with modern tools and technologies.</li>
                            <li>Provided ongoing support and maintenance for client projects.</li>
                        </ul>
                    </div>
                </div>
            </motion.div>
            ...
            >
                ...
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                    <li>Ranked in the top 5% on LeetCode global leaderboard.</li>
                    <li>Won the 2023 Smart India Hackathon.</li>
                    <li>Certified in Full-Stack Development from XYZ Academy.</li>
