...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 text-white p-8 relative">
      ...
      >
        <img
          src="https://img.freepik.com/free-psd/spaceship-rocket-icon-isolated-3d-render-illustration_439185-11908.jpg?t=st=1734939926~exp=1734943526~hmac=ade7b2be3064ab00eba0670df0c5a95d8defb3800f402551f494de6081a066bc&w=826"
          alt="Decorative"
