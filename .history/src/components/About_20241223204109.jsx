...
export default function About() {
    return (
        ...
        >
            {/* Title Section */}
            <motion.h1
                className=" dark:bg-gray-900 text-3xl sm:text-5xl font-bold text-gray-900 text-orange-500 hover:text-orange-700 focus:text-orange-700 text-center mb-8"
            ...
            {/* Introduction */}
            <motion.div
                className="flex dark:bg-gray-900 flex-col sm:flex-row items-center gap-8 mb-12"
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
            >
                <motion.img
                    src="https://i.ibb.co/DMh5pWC/Whats-App-Image-2024-12-23-at-16-23-12-10c8e4b6.jpg" // Replace with your actual image path
                    alt="About Me"
